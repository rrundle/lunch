              ...
              <div className="blog-box blog-details">
                ...
                <div className="blog-details">
                  <ul className="blog-social">
                    ...
                    <li>
                      <i className="icofont icofont-user"></i>John{' '}
                      <span>Deo </span>
                    </li>
                    <li className="digits">
                        ...
                        <div className="row">
                          <div className="col-md-4 xl-100">
                            <h6 className="mt-0">
                              ...
                              <span> ( {singleData.student_designation} )</span>
                            </h6>
                          </div>
                          ...
                          <div className="media-body">
                            <div className="row">
                              <div className="col-xl-12">
                                <h6 className="mt-0">
                                  {singleData.writer_name}
                                  <span>
                                    {' '}
                                    ( {singleData.student_designation} )
                                  </span>
                                </h6>
                              </div>
                            </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-8 xl-100">
                            <ul className="comment-social float-left float-md-right learning-comment">
                              ...
                              <li className="digits">
                                <i className="icofont icofont-ui-chat"></i>328
                                Comments
                              </li>
                            </ul>
                          </div>
