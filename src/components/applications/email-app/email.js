                    ...
                    <div className="email-app-sidebar">
                      ...
                      <ul className="nav main-menu" role="tablist">
                        <li className="nav-item" onClick={clickCompose}>
                          <a
                            className="btn-primary btn-block btn-mail"
                ...
                <div className="card email-body">
                  <div className="pr-0 b-r-light">
                        ...
                        <div className="col text-right">
                          <div className="dropdown">
                            <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                              ...
                              <DropdownMenu>
                                <DropdownItem
                                  onClick={() => moveEmails('draft')}
                                >
                                  Draft
                                </DropdownItem>
                                <DropdownItem
                                  onClick={() => moveEmails('trash')}
                                >
                                  Trash
                                </DropdownItem>
                                <DropdownItem
                                  onClick={() => moveEmails('spam')}
                                >
                                  Spam
                                </DropdownItem>
                              </DropdownMenu>
                    ...
                    <div className="inbox custom-scrollbar">
                      {selectedFav ? (
                        usersList.filter((email) => email.favourite === true)
                          .length > 0 ? (
                          usersList
                                ...
                                >
                                  <label className="d-block" htmlFor="chk-ani">
                                    <input
                                      ...
                                      name="chk-ani"
                                      type="checkbox"
                                      onChange={(e) => selectedmail(e, list.id)}
                            ...
                            >
                              ...
                              <div className="media-size-email">
                                <img
                                  className="mr-3 rounded-circle"
                                  src={
                                    list.image ? dynamicImage(list.image) : ''
                                  }
                                  alt=""
                                />
                              </div>
                        ...
                        usersList.map((list, index) => {
                          return (
                            ...
                            >
                              ...
                              <div className="media-size-email">
                                <img
                                  className="mr-3 rounded-circle img-60"
                                  src={
                                    list.image ? dynamicImage(list.image) : ''
                                  }
                                  alt=""
                      ...
                      >
                        <div className="email-content">
                            ...
                            <div className="row">
                              <div className="col-md-6 xl-100 col-sm-12">
                                <div className="media">
                                  <img
                                    className="mr-3 rounded-circle img-50"
                                    src={
                                      singleMailRecord.image
                                        ? dynamicImage(singleMailRecord.image)
                                        : ''
                                    }
                                    alt=""
                                  />
                                  <div className="media-body">
                                    <h6>
                                      ...
                                      <small>
                                        <span className="digits">
                                          {singleMailRecord.date}
                                        </span>{' '}
                                        <span className="digits">6:00</span> AM
                                      </small>
                                    </h6>
                              ...
                              <div className="col-md-6 col-sm-12">
                                <div
                                  ...
                                  onClick={() => addFavourite(singleMailRecord)}
                                >
                                  <p className="user-emailid">
                                    Lormlpsa<span className="digits">23</span>
                                    @company.com
                                  </p>
                                  <i
                                    className={`fa fa-star-o f-18 mt-1 ${
                                      singleMailRecord.favourite
                                        ? 'starred'
                                        : ''
                                    } `}
                                  ></i>
                          ...
                          <div className="email-wrapper">
                            ...
                            <h5>
                              Elementum varius nisi vel tempus. Donec eleifend
                              egestas viverra.
                            </h5>
                            <p className="m-b-20">
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Curabitur non diam facilisis, commodo libero
                              et, commodo sapien. Pellentesque sollicitudin
                              massa sagittis dolor facilisis, sit amet vulputate
                              nunc molestie. Pellentesque maximus nibh id luctus
                              porta. Ut consectetur dui nec nulla mattis luctus.
                              Donec nisi diam, congue vitae felis at,
                              ullamcorper bibendum tortor. Vestibulum
                              pellentesque felis felis. Etiam ac tortor felis.
                              Ut elit arcu, rhoncus in laoreet vel, gravida sed
                              tortor.
                            </p>
                            <p>
                              In elementum varius nisi vel tempus. Donec
                              eleifend egestas viverra. Donec dapibus
                              sollicitudin blandit. Donec scelerisque purus sit
                              amet feugiat efficitur. Quisque feugiat semper
                              sapien vel hendrerit. Mauris lacus felis,
                              consequat nec pellentesque viverra, venenatis a
                              lorem. Sed urna lectus.Quisque feugiat semper
                              sapien vel hendrerit
                            </p>
                            <hr />
                            <div className="d-inline-block">
                              ...
                              <a
                                className="text-muted text-right right-download"
                                href="#javascript"
                              >
                                <i className="fa fa-long-arrow-down mr-2"></i>
                                Download All
                              </a>
                            ...
                            <div className="action-wrapper">
                              <ul className="actions">
                                ...
                                <li>
                                  <a className="text-muted" href="#javascript">
                                    <i className="fa fa-reply-all mr-2"></i>
                                    Reply All
                                  </a>
                                </li>
                                <li>
