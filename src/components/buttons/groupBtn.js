          ...
          <div className="col-12">
            <div className="card">
              <div className="card-header">
                ...
                <span>
                  Add <code>.active</code> for active state and
                  <code>.disabled</code> class or{' '}
                  <code>disabled="disabled"</code> attribute
                </span>
              </div>
              <div className="card-body btn-group-showcase">
                <div className="row">
            ...
            <div className="card height-equal">
              ...
              <div className="card-body btn-group-wrapper">
                <ButtonGroup vertical>
                  ...
                  <Button color="secondary" type="button" className="b-r-0">
                    Button
                  </Button>
                  <UncontrolledDropdown>
                  ...
                  <Button color="info" type="button" className="b-r-0">
                    Button
                  </Button>
