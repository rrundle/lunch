              ...
              <div className="card-body">
                <div className="media bitcoin-graph">
                  <svg
                    ...
                    style={{ enableBackground: 'new 0 0 511.4 511.4' }}
                    xmlSpace="preserve"
                  >
                    <g>
                      <g>
              ...
              <div className="card-body">
                <div className="media bitcoin-graph">
                  <svg
                    ...
                    style={{ enableBackground: 'new 0 0 510.8 510.8' }}
                    xmlSpace="preserve"
                  >
                    <g>
                      <g>
              ...
              <div className="card-body">
                <div className="media bitcoin-graph">
                  <svg
                    ...
                    x="0px"
                    y="0px"
                    viewBox="0 0 511.496 511.496"
                    style={{ enableBackground: 'new 0 0 511.496 511.496' }}
                    xmlSpace="preserve"
                  >
                    <g>
                      <g>
          ...
          <div className="col-xl-4 xl-50">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="media markets mb-0">
                  <img src={market4} alt="" />
                  <div className="media-body">
                    <h5 className="font-primary">03 Jan</h5>
                    <p>
                      ...
                      <ul>
                        <li>
                          <div className="message my-message">
                            <img
                              className="rounded-circle float-left chat-user-img"
                              src={chat1}
                              alt=""
                            />
                        ...
                        <li className="clearfix">
                          <div className="message other-message pull-right">
                            <img
                              className="rounded-circle float-right chat-user-img"
                              src={chat2}
                              alt=""
                            />
