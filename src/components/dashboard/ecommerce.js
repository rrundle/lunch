                      ...
                      <tr>
                        <td>
                          <div className="d-inline-block align-middle">
                            <img
                              className="img-radius img-30 align-top m-r-15 rounded-circle"
                              src={six}
                              alt=""
                            />
              ...
              <div className="card-body">
                <div className="number-widgets">
                  <div className="media">
                    ...
                    <div
                      className="radial-bar radial-bar-95 radial-bar-primary"
                      data-label="95%"
                    ></div>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="number-widgets">
                  <div className="media">
                    ...
                    <div
                      className="radial-bar radial-bar-75 radial-bar-primary"
                      data-label="75%"
                    ></div>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="number-widgets">
                  <div className="media">
                    ...
                    <div
                      className="radial-bar radial-bar-90 radial-bar-primary"
                      data-label="90%"
                    ></div>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="number-widgets">
                  <div className="media">
                    ...
                    <div
                      className="radial-bar radial-bar-80 radial-bar-primary"
                      data-label="80%"
                    ></div>
                  </div>
                </div>
          ...
          <div className="col-xl-4 xl-50 col-md-6">
            <div className="card">
              ...
              <div className="card-body height-equal log-content">
                ...
                <div className="logs-element">
                  <div className="circle-double-even"></div>
              ...
              <div className="card-body updating-chart height-equal">
                <div className="upadates text-center">
                  <h2 className="font-primary">
                    ...
                    <span>
                      {' '}
                      <CountUp className="counter" end={89.65} />
                      89.68{' '}
                    </span>
                    <ArrowUp />
                  </h2>
                  <p>
                    Week2 +
                    <span>
                      <CountUp className="counter" end={15.44} />
                      15.44
                    </span>
                  </p>
                </div>
