            ...
            <div className="card">
              ...
              <div className="card-body">
                <Slider {...basic_settings}>
                  ...
                  <img
                    className="p-2"
                    src={require('../../assets/images/slider/6.jpg')}
                    alt=""
                  />
                  <img
                    className="p-2"
                    src={require('../../assets/images/slider/7.jpg')}
                    alt=""
                  />
                  <img
                    className="p-2"
                    src={require('../../assets/images/slider/8.jpg')}
                    alt=""
                  />
                  <img
                    className="p-2"
                    src={require('../../assets/images/slider/9.jpg')}
                    alt=""
                  />
                  <img
                    className="p-2"
                    src={require('../../assets/images/slider/10.jpg')}
                    alt=""
                  />
                  <img
                    className="p-2"
                    src={require('../../assets/images/slider/11.jpg')}
                    alt=""
                  />
                  <img
                    className="p-2"
