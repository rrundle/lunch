...
const General = () => {
  ...
  useEffect(() => {
    setInterval(() => setDate({ date: new Date() }), 1000)
  }, [date, startDate])
            ...
            <div className="widget-joins card">
              <div className="row">
                ...
                <div className="col-sm-6 pl-0">
                  <div className="media">
                    <div className="align-self-center mr-3 digits">
                      12%<i className="fa fa-angle-down ml-2"></i>
                    </div>
                    <div className="media-body details pl-3">
                ...
                <div className="col-sm-6 pr-0">
                  <div className="media border-after-xs">
                    <div className="align-self-center mr-3">
                      68%<i className="fa fa-angle-up ml-2"></i>
                    </div>
            ...
            <div className="card social-widget-card">
              <div className="card-body">
                <div
                  ...
                  data-label="50%"
                >
                  <i className="fa fa-facebook font-primary"></i>
                </div>
            ...
            <div className="card social-widget-card">
              <div className="card-body">
                <div
                  ...
                  data-label="50%"
                >
                  <i className="fa fa-twitter font-primary"></i>
                </div>
            ...
            <div className="card social-widget-card">
              <div className="card-body">
                <div
                  ...
                  data-label="50%"
                >
                  <i className="fa fa-google-plus font-primary"></i>
                </div>
                ...
                <div className="row">
                  <div className="col text-center b-r-light">
                    <span>Post</span>
                    <h4 className="counter mb-0">
                      <CountUp className="counter" end={369} />
                    </h4>
                  </div>
                  <div className="col text-center">
                    <span>Follower</span>
            ...
            <div className="card browser-widget">
              <div className="media card-body">
                <div className="media-img">
                  <img
                    src={require('../../assets/images/dashboard/chrome.png')}
                    alt=""
                  />
                </div>
                <div className="media-body align-self-center">
                  ...
                  <div>
                    ...
                    <h4>
                      <span className="counter">
                        <CountUp className="counter" end={46} />
                      </span>
                      %
                    </h4>
                  </div>
          ...
          <div className="col-md-4 col-sm-12">
            <div className="card browser-widget">
              <div className="media card-body">
                <div className="media-img">
                  <img
                    src={require('../../assets/images/dashboard/firefox.png')}
                    alt=""
                  />
                </div>
                <div className="media-body align-self-center">
          ...
          <div className="col-md-4 col-sm-12">
            <div className="card browser-widget">
              <div className="media card-body">
                <div className="media-img">
                  <img
                    src={require('../../assets/images/dashboard/safari.png')}
                    alt=""
                  />
                </div>
                <div className="media-body align-self-center">
              ...
              <div className="calender-widget">
                ...
                <div className="cal-desc text-center card-body">
                  <h6 className="f-w-600">
                    I must explain to you how all this mistaken idea truth
                  </h6>
                  <p className="text-muted mt-3 mb-0">
                    Denouncing pleasure and praising pain was born and I will
                    give you a complete account of the system, and expound the
                    actual teachings of the great explorer of the truth,Letraset
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <ul className="crm-activity">
                    ...
                    <li className="media">
                      <span className="mr-3 font-primary">T</span>
                      <div className="align-self-center media-body">
                        <h6 className="mt-0">
                    ...
                    <li className="media">
                      <span className="mr-3 font-primary">H</span>
                      <div className="align-self-center media-body">
                        <h6 className="mt-0">
            ...
            <div className="card custom-card">
              ...
              <div className="card-footer row">
                ...
                <div className="col-4 col-sm-4">
                  ...
                  <h3>
                    <span className="counter">
                      <CountUp className="counter" end={49} />
                    </span>
                    K
                  </h3>
                </div>
              ...
              <div className="card-body">
                <Slider {...settings}>
                  <div className="item">
                    ...
                    <img
                      className="img-80"
                      src={require('../../assets/images/dashboard/boy-2.png')}
                      alt=""
                    />
                ...
                <div className="row">
                  <div className="col-6">
                    ...
                    <h3 className="total-num counter">
                      <CountUp className="counter" end={25639} />
                    </h3>
                  </div>
                  <div className="col-6">
                    <div className="text-md-right">
                      <ul>
                        <li>
                          Profit
                          <span className="product-stts font-primary ml-2">
                            8989<i className="icon-angle-up f-12 ml-1"></i>
                          </span>
                        </li>
                        <li>
                          Loss
                          <span className="product-stts font-primary ml-2">
                            2560<i className="icon-angle-down f-12 ml-1"></i>
                          </span>
                        </li>
                      </ul>
                    </div>
