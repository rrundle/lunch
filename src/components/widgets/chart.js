              ...
              <div className="bar-chart-widget">
                <div className="top-content bg-primary">
                  <div className="row">
                    <div className="col-7">
                      <div
                        className="bar-chart card-body pb-0"
                ...
                <div className="bottom-content card-body">
                  <div className="row">
                    <div className="col-4 b-r-light">
                      <div>
                        <span className="num font-primary">
                          12%<i className="icon-angle-up f-12 ml-1"></i>
                        </span>
                    ...
                    <div className="col-4 b-r-light">
                      <div>
                        <span className="num font-primary">
                          15%<i className="icon-angle-up f-12 ml-1"></i>
                        </span>
                        <span className="text-muted mt-2 mb-2 block-bottom">
                          Affiliate
                        </span>
                    ...
                    <div className="col-4">
                      <div>
                        <span className="num font-primary">
                          34%<i className="icon-angle-up f-12 ml-1"></i>
                        </span>
                        <span className="text-muted mt-2 mb-2 block-bottom">
                          Advertise
                        </span>
