                ...
                <div className="row icon-lists whether-icon">
                  ...
                  <div className="col-lg-2 col-3">
                    <svg
                      version="1.1"
                      id="sunriseAlt"
                      className="climacon climacon_sunriseAlt"
                      viewBox="15 15 70 70"
                    >
                  ...
                  <div className="col-lg-2 col-3">
                    <svg
                      version="1.1"
                      id="sunriseAltFill"
                      className="climacon climacon_sunriseAltFill"
                      viewBox="15 15 70 70"
                    >
                  ...
                  <div className="col-lg-2 col-3">
                    <svg
                      version="1.1"
                      id="sunsetAltfill"
                      className="climacon climacon_sunsetAlt"
                      viewBox="15 15 70 70"
                    >
                  ...
                  <div className="col-lg-2 col-3">
                    <svg
                      version="1.1"
                      id="sunsetAltFill"
                      className="climacon climacon_sunsetAltFill"
                      viewBox="15 15 70 70"
                    >
