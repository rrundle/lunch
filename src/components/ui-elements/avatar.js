            ...
            <div className="col-xl-6 xl-100">
              <div className="card">
                ...
                <div className="card-body avatar-showcase">
                  <div className="avatars">
                    <div className="avatar">
                      <img className="img-100 b-r-8" src={one} alt="#" />
                    </div>
                    <div className="avatar">
                      <img className="img-90 b-r-30" src={one} alt="#" />
                    </div>
                    <div className="avatar">
                      <img className="img-80 b-r-35" src={one} alt="#" />
                    </div>
                    <div className="avatar">
                      <img
                        className="img-70 rounded-circle"
                    ...
                    <div className="avatar">
                      <img className="img-60 b-r-25" src={one} alt="#" />
                    </div>
                    <div className="avatar">
                ...
                <div className="card-body avatar-showcase">
                  <div className="avatars">
                    <div className="avatar ratio">
                      <img className="b-r-8 height-100" src={one} alt="#" />
                    </div>
                    <div className="avatar ratio">
                      <img className="b-r-8 height-90" src={one} alt="#" />
                    </div>
                    <div className="avatar ratio">
                      <img className="b-r-8 height-80" src={one} alt="#" />
                    </div>
                    <div className="avatar ratio">
                      <img className="b-r-8 height-70" src={one} alt="#" />
                    </div>
                    <div className="avatar ratio">
                      <img className="b-r-8 height-60" src={one} alt="#" />
                    </div>
                    <div className="avatar ratio">
                      <img className="b-r-8 height-50" src={one} alt="#" />
                    </div>
                  </div>
                </div>
              </div>
