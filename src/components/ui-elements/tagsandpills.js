          ...
          <div className="col-sm-12 col-xl-6">
            <div className="card height-equal">
              ...
              <div className="card-body">
                ...
                <div className="mb-3">
                  <button className="btn badge-success" type="button">
                    Update available{' '}
                    <span className="badge badge-pill badge-light">
                      <Settings />
                    </span>
                ...
                <div className="mb-3">
                  <button className="btn badge-info" type="button">
                    Playing Now{' '}
                    <span className="badge badge-pill badge-light">
                      <Music />
                    </span>
                ...
                <div className="mb-3">
                  <button className="btn badge-warning" type="button">
                    1.2 GB Used{' '}
                    <span className="badge badge-pill badge-light">
                      <AlertTriangle />
                    </span>
                ...
                <div>
                  <button className="btn badge-danger" type="button">
                    Alert{' '}
                    <span className="badge badge-pill badge-light">
                      <AlertCircle />
                    </span>
