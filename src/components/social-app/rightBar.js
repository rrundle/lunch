...
const RightBar = () => {
  ...
  return (
    <Fragment>
          ...
          <Collapse isOpen={isIntro}>
            <div className="card-body filter-cards-view">
              ...
              <div className="social-network theme-form">
                ...
                <button className="btn social-btn btn-fb mb-2 text-center">
                  <i className="fa fa-facebook m-r-5"></i>Facebook
                </button>
                <button className="btn social-btn btn-twitter mb-2 text-center">
                  <i className="fa fa-twitter m-r-5"></i>Twitter
                </button>
                <button className="btn social-btn btn-google text-center">
      ...
      <div className="col-xl-12 xl-50">
        <div className="card">
          <img className="img-fluid" src={timeline4} alt="" />
        </div>
      </div>
    </Fragment>
  )
