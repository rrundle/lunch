          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                <h5>Double Border</h5>
                <span>
                  Example of a <code>double</code> border inside table head.
                  This border has <code>3px</code> width, <code>double</code>{' '}
                  style and inherits all styling options from the default border
                  style. Visually it displays table <code>head</code> and{' '}
                  <code>body</code> as 2 separated table areas. To use this
                  border add <code>.border-double</code> to the table head row.
                </span>
              </div>
              <div className="table-responsive">
                <table className="table">
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                <h5>Dotted Border</h5>
                <span>
                  Example of a <code>dotted</code> border inside table head.
                  This border has <code>3px</code> width, <code>dotted</code>{' '}
                  style and inherits all styling options from the default border
                  style. Visually it displays table <code>head</code> and{' '}
                  <code>body</code> as 2 separated table areas. To use this
                  border add <code>.border-dotted</code> to the table head row.
                </span>
              </div>
              <div className="table-responsive">
                <table className="table">
          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                <h5>Dashed Border</h5>
                <span>
                  Example of a <code>dashed</code> border inside table head.
                  This border has <code>3px</code> width, <code>dashed</code>{' '}
                  style and inherits all styling options from the default border
                  style. Visually it displays table <code>head</code> and{' '}
                  <code>body</code> as 2 separated table areas. To use this
                  border add <code>.border-dashed</code> to the table head row.
                </span>
              </div>
              <div className="table-responsive">
                <table className="table">
