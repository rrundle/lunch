              ...
              <form className="form theme-form">
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlSelect7">
                          Example select
                        </label>
                        <select
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlSelect8">
                          Example multiple select
                        </label>
                        <select
                          className="form-control btn-pill p-l-45 digits"
              ...
              <form className="form theme-form">
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlInput15">
                          Email address
                        </label>
                        <input
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlSelect18">
                          Example multiple select
                        </label>
                        <select
                          className="form-control input-air-primary digits"
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group mb-0">
                        <label htmlFor="exampleFormControlTextarea19">
                          Example textarea
                        </label>
                        <textarea
                          className="form-control input-air-primary"
              ...
              <form className="form theme-form">
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlInput20">
                          Email address
                        </label>
                        <input
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group mb-0">
                        <label htmlFor="exampleFormControlTextarea25">
                          Example textarea
                        </label>
                        <textarea
                          className="form-control"
              ...
              <form className="form theme-form">
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleInputPassword27">
                          Default input
                        </label>
                        <input
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlSelect29">
                          Large select
                        </label>
                        <select
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <label htmlFor="exampleFormControlSelect30">
                          Default select
                        </label>
                        <select
                          className="form-control digits"
                  ...
                  <div className="row">
                    <div className="col">
                      <div className="form-group mb-0">
                        <label htmlFor="exampleFormControlSelect31">
                          Small select
                        </label>
                        <select
